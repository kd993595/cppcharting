...
void BoxPlot::show() const{
    ...
    while (!WindowShouldClose()){
        ...
        /* draw the min */
        DrawLine(horiz_middle - 25, win_height - vertical_padding, horiz_middle + 25, win_height - vertical_padding, color);

        /* draw the box */
        double q1_portion = (q1 - min) / range;
        int q1_y_offset = q1_portion * plot_height;
        int q1_y = win_height - vertical_padding - q1_y_offset;

        double q3_portion = (q3 - min) / range;
        int q3_y_offset = q3_portion * plot_height;
        int q3_y = win_height - vertical_padding - q3_y_offset;
        ...
        int q2_y = win_height - vertical_padding - q2_y_offset;
